...
@click.option(
    "--write_embeddings",
    is_flag=True,
    help="Dump the s, z embeddings and pdistogram into a npz file. Default is False.",
)
@click.option(
    "--embeddings_only",
    is_flag=True,
    help="Skip diffusion and structure prediction, only compute and save embeddings. Default is False.",
)
def predict(  # noqa: C901, PLR0915, PLR0912
    ...
    # Automatically enable embeddings writing when embeddings_only is set
    if embeddings_only:
        write_embeddings = True
        click.echo("Embeddings only mode: skipping diffusion and structure prediction.")
    ...
    if filtered_manifest.records:
        ...
        model_module = model_cls.load_from_checkpoint(
            ...
            skip_run_structure=embeddings_only,
        )
        model_module.eval()
    ...
    if any(r.affinity for r in manifest.records) and not embeddings_only:
        # Print header
