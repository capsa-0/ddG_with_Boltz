...
substitution-identity control gives +0.224 [+0.167, +0.255] on FireProt, +0.143 on S669.
...
| Code | `tsu_class_error.py` (Tsuboyama OOF), `mut_class_error.py` (S669), `transfer_class_error.py` (both blind corpora, transfer readout) |
| Result tables | `transfer_class_tables.csv` (every class × corpus × grouping), `transfer_class_bootstrap.csv` (the cluster-bootstrap contrasts) |
